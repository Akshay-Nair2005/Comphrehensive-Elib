    ...
    <section className="px-4 py-10 h-[100vh]">
      <div className="container-xl lg:container m-auto">
        <div className="flex justify-between items-center px-6 mb-4">
          ...
          {isHome ? (
            <Link to="/novels" className="text-black text-lg flex items-center">
        ...
        {!isHome && (
          <div className="flex flex-col md:flex-row gap-4 mb-6 px-6">
            ...
            <select
              ...
              className="px-4 py-2 rounded-md w-1/4 md:w-1/2 bg-[#5E3023] text-white"
            >
            ...
            >
              {Array.from({ length: skeletonCount }).map((_, index) => (
                <SwiperSlide key={index}>
                  <div className="p-4 bg-[#5E3023] rounded-md">
                    <Skeleton
                      height={200}
                      baseColor="#E1CDBB"
