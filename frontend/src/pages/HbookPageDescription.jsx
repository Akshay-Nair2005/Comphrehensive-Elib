...
const HbookPageDescription = () => {
    ...
    if (loading) {
        return (<div className="flex flex-col items-center justify-center h-screen ">
            ...
            {/* Loader Text */}
            <p className="mt-4 text-lg font-medium text-white">Loading your book...</p>
        </div>);
    }
        ...
        <section>
            <div className="flex flex-col lg:flex-row items-center justify-between p-6 space-y-6 lg:space-y-0 lg:space-x-10">
                ...
                <div className="w-full lg:w-2/3 text-[#FFf] space-y-6">
                    <h1 className="text-4xl font-bold text-[#F87871]">{hbook.hbook_name}</h1>
                    {renderDescription(
                        hbook.hbook_desc,
                        NOVEL_DESC_LIMIT,
                        showFullNovelDesc,
...
export default HbookPageDescription