...
export const HbookPageDescription = () => {
  ...
  const saveBook = async () => {
    ...
    try {
      ...
      const userResponse = await fetch(`http://localhost:5000/user/${userrId}/`);
            ...
            <div className="sticky top-8">
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                <div className="bg-white rounded-xl p-3 text-center shadow-md hover:shadow-lg transition-shadow">
                  ...
                  <p className="font-bold text-[#5E3023]">Book</p>
                </div>
                <div className="bg-white rounded-xl p-3 text-center shadow-md hover:shadow-lg transition-shadow">
                  <FaPenAlt className="text-xl text-[#5E3023] mx-auto mb-1" />
                  <p className="text-xs text-gray-500">Open for</p>
                  <p className="font-bold text-[#5E3023]">Contributions</p>
                </div>
                <div className="bg-white rounded-xl p-3 text-center shadow-md hover:shadow-lg transition-shadow">
                  <HiSparkles className="text-xl text-amber-500 mx-auto mb-1" />
                  <p className="text-xs text-gray-500">Status</p>
                  <p className="font-bold text-[#5E3023]">Active</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-3/5 xl:w-2/3 space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span className="text-lg">by <span className="font-semibold text-[#5E3023]">{hbook.hbook_author}</span></span>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-[#5E3023]/5 to-[#5E3023]/10 rounded-2xl p-6 space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-[#5E3023] rounded-full flex items-center justify-center text-white font-bold text-lg">
                  {hbook.hbook_author?.charAt(0)?.toUpperCase() || "A"}
                </div>
                <div>
                  <p className="text-sm text-gray-500">About the Author</p>
                  <h3 className="font-semibold text-[#5E3023] text-lg">{hbook.hbook_author}</h3>
                </div>
              </div>
              <div className="text-gray-700">
                {renderDescription(
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              ...
              <Link
                to={`/uedit/${hbook.$id}`}
                className="flex-1 min-w-[140px] inline-flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
              >
                <FaPenAlt />
                Contribute
              </Link>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
              <HiSparkles className="text-xl text-amber-600 flex-shrink-0 mt-0.5" />
              <div>
                <p className="font-medium text-amber-800">Open for Contributions</p>
                <p className="text-sm text-amber-700">This is a community book. You can contribute your own chapters and become part of the story!</p>
              </div>
            </div>
          </div>
        </div>
